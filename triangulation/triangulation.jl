...
# ╔═╡ acf17873-3078-454a-b848-55df6d25e897
using Images, TestImages, ImageDraw, LinearAlgebra

# ╔═╡ 9bcbd49e-fd71-11eb-35b2-23b4827cc064
...
# ╔═╡ 8237228f-e4a4-45b4-b253-9d31a67f18bd
...
# ╔═╡ c29472b8-d7de-452c-9cec-e66149875934
function convex_hull(points::Vector{CartesianIndex{2}})
	# setup
...
# ╔═╡ 82c738d8-7996-4bf0-b9cd-0c91a230945a
# You can use where in {} to make multiple statements
function draw_lines(Arr::Array{T, 2}, points::Vector{U}) where {T, U}
	img = copy(Arr)
...
# ╔═╡ 1ea8d3f0-b47a-4471-8ef3-2bf01f877152
begin
	img = Array{RGB{Normed{UInt8,8}},2}(undef, (300, 300));
	img[:] .= typeof(img[1])(1, 1, 1)
	points = rand_points(img, 20)
	img[points] .= typeof(img[1])(0, 0, 0)
	
	hull = convex_hull(points)
	draw_lines(img, hull)
end

# ╔═╡ ef92554c-b847-4532-b477-9c7a198383bb
